...
## Feature Tasks  
[ ]For this assignment you will be building a RESTful HTTP server with basic authentication using 
express.
...
## Documentation
[ ] In the README.md write documentation for starting your server 
[ ] and making requests to each endpoint it provides. 
[ ] The documentation should describe how the server would respond to valid and invalid requests.
